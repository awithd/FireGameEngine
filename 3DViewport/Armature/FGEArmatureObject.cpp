#include "FGEArmatureObject.h"

FGEArmatureObject::FGEArmatureObject(FGEDataProject *data_project, FGETriggerFunction *trigger, QString name_parent, FGEOpenGLWidget *glwidget_world, QWidget *parent) :
    QWidget(parent)
{
...
"}"));
    ...
    /*listWidget_meshes_armatures->setStyleSheet(
                QString::fromUtf8("background-color: red;"));*/

    /*QLatin1String style_sheet = QLatin1String(".QListWidget::item{\n"
                                              "         border-style: solid;\n"
                                              "         border-width:1px;\n"
                                              "         border-color:black;\n"
                                              ...
                                              "}");
    listWidget_meshes_armatures->setStyleSheet(style_sheet);*/

    /*groupBox_make_skin = new QGroupBox(parent);
    groupBox_make_skin->setObjectName(QString::fromUtf8("groupBox_make_skin"));
    groupBox_make_skin->setGeometry(QRect(10, 10, 421, 291));
    gridLayout = new QGridLayout(groupBox_make_skin);
    gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
    pushButton_make_skin = new QPushButton(groupBox_make_skin);
    pushButton_make_skin->setObjectName(QString::fromUtf8("pushButton_make_skin"));
    pushButton_make_skin->setMinimumSize(QSize(30, 30));
    pushButton_make_skin->setMaximumSize(QSize(30, 30));

    gridLayout->addWidget(pushButton_make_skin, 0, 2, 1, 1);

    listWidget_meshes_armatures = new QListWidget(groupBox_make_skin);
    listWidget_meshes_armatures->setObjectName(QString::fromUtf8("listWidget_meshes_armatures"));

    gridLayout->addWidget(listWidget_meshes_armatures, 1, 0, 1, 4);

    label = new QLabel(groupBox_make_skin);
    label->setObjectName(QString::fromUtf8("label"));
...
void FGEArmatureObject::link(QString name_parent, FGEDataProject *data_project, FGETriggerFunction *trigger, QWidget *menu, QWidget *body){
...
void FGEArmatureObject::prepare()
{
...
void FGEArmatureObject::copyNode(bool click)
{
...
void FGEArmatureObject::selectItem(QListWidgetItem* click)
{
    groupBox->setEnabled(true);
...
void FGEArmatureObject::linkArmaturesMeshs(bool st)
{
