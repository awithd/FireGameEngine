#ifndef FGESELECTIONARMATURE_H
#define FGESELECTIONARMATURE_H
...
class FGESelectionArmature : public QOpenGLFunctions
{
public:
    FGESelectionArmature();
    ...
    bool getSelectedObjects(int mode, int r, int g, int b);
