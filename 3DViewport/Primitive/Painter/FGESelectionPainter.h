#ifndef FGESELECTIONPAINTER_H
#define FGESELECTIONPAINTER_H
...
class FGESelectionPainter : protected QOpenGLFunctions
{
public:
    FGESelectionPainter(FGEGLSL *shader=NULL);
    ...
    void _paint(OpenGLFunctions *f, FGEDataNode *node, FGEDataSkin* skin, FGEDataMesh *mesh, FGENodeShaderItem *item, glm::vec3 &color);
...
private:
    void drawTriagnles(OpenGLFunctions *f, FGEDataSkinTriangleBuffer *skin_trian, FGEDataTriangles *triangles);
    void drawQuads(OpenGLFunctions *f, FGEDataSkinQuadBuffer *skin_quads, FGEDataQuads *quads);
    void drawPolygons(OpenGLFunctions *f, FGEDataSkinPolygonBuffer *skin_polygons, FGEDataPolygons *polygons);

};
#endif // FGESELECTIONPAINTER_H
