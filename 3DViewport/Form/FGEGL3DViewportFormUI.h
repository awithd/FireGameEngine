/********************************************************************************
** Form generated from reading UI file 'FGEGL3DViewportFormBzcEQH.ui'
**
...
class FGEGL3DViewportFormUI
{
public:
    FGEGL3DViewportFormUI(){
    ...
    void setupUi(FGETriggerFunction *trig, FGECreateNewObject *create_new_object, FGEDataProject *sp, QString name, void *dock,QWidget *FGEGL3DViewportForm)
    {
        ...
        FGEGL3DViewportForm->resize(650, 449);
...
"\n"
""));
        gridLayout_2 = new QGridLayout(FGEGL3DViewportForm);
        ...
        gridLayout = new QGridLayout(widget_cont);
...
""));
        ...
        topwidget->setGeometry(QRect(0, 0, 542, 28));
...
"}"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/Icons/blender_icons/con_armature.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_armature->setIcon(icon5);
        pushButton_armature->setIconSize(QSize(18, 18));
        ...
        widget_menu->setGeometry(QRect(28, 0, 202, 28));
        widget_menu->setMinimumSize(QSize(202, 28));
        widget_menu->setMaximumSize(QSize(200, 28));
        widget_menu->setStyleSheet(QString::fromUtf8("#widget_menu {\n"
...
"}"));
        ...
        gridLayout->addWidget(glwidget_world, 1, 0, 1, 1);


        gridLayout_2->addWidget(widget_cont, 0, 0, 1, 1);
