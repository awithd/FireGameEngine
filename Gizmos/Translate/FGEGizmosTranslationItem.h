#ifndef FGEGIZMOSTRANSLATIONITEM_H
#define FGEGIZMOSTRANSLATIONITEM_H
...
class FGEGizmosTranslationItem
{
public:
    FGEGizmosTranslationItem(OpenGLFunctions *f);
...
#endif // FGEGIZMOSTRANSLATIONITEM_H
