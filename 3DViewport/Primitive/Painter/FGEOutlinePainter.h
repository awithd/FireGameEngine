#ifndef FGEOUTLINEPAINTER_H
#define FGEOUTLINEPAINTER_H
...
class FGEOutlinePainter : protected QOpenGLFunctions
{
public:
    FGEOutlinePainter(FGEGLSL *shader=NULL);
...
private:
    ...
    void drawQuads(OpenGLFunctions *f, FGEDataQuads *quads, FGESelectionEditMode *sem);
    void drawPolygons(OpenGLFunctions *f, FGEDataPolygons *polygons, FGESelectionEditMode *sem);

};
#endif // FGEOUTLINEPAINTER_H
