#ifndef FGESELECTIONARMATUREEDITABLE_H
#define FGESELECTIONARMATUREEDITABLE_H
...
class FGESelectionArmatureEditable : public QOpenGLFunctions
{
public:
    FGESelectionArmatureEditable();
...
#endif // FGESELECTIONARMATUREEDITABLE_H
