#ifndef FGEOBJECTMODEDELING_H
#define FGEOBJECTMODEDELING_H
...
class FGEObjectModeling : public QWidget
{
    Q_OBJECT
public:
    explicit FGEObjectModeling(FGEDataProject *data_project, FGETriggerFunction *trigger, QString name_parent, FGEOpenGLWidget *glwidget_world, QWidget *parent = 0);
